        ...
        <div class="row">
            ...
            <div class="col-md-9">    
                 <div id="divright">
                     ...
                     <div id="menu">
                     <p style="text-align:center;font-size:200%;color:black;font-weight: bold;font-family: '微軟正黑體';">新增影音資料夾</p>
                    </div>
                ...
                <br/><br/>
                    ...
                    <form action='action.php' method='post'>
                        <label for='dirName'>影音資料夾名稱：</lebel>
                        <input  required size=25 name='dirName' type='text'/>&nbsp;&nbsp;&nbsp;
                        <button onclick='createVideoDir()' class='btn btn-lg btn-primary' type='submit'>確定新增</button>
                    </form>
                  <br/><br/>  <br/>
