             ...
             <div class="col-md-3">
              ...
              <div class="col-md-9">    
                 <div id="divright">
                     ...
                     <div id="menu">
                     <p style="text-align:center;font-size:200%;color:black;font-weight: bold;font-family: '微軟正黑體';">話題新增</p>
                    </div>
                    <div class='row'>
                    <div class="col-md-10 col-md-offset-1">
                        <br><br>
                        <form class="form-horizontal" name="createDiscussFrom" action="action.php" method="get">
                            <div class='row'>
                                <div class='col-md-8'>
                                    <label for='title' >話題標題： </label>
                                    <input required type='text' name='title' size=22 placeholder="請填寫話題標題"><br><br>                                                   
                                </div>
                                <div class='col-md-8'>
                                    <label for='class'>話題種類：</label>
                                    <input required type='text' name='class' size=10 placeholder="請填寫話題類型"><br><br>
                                </div>
                            </div>                     
                             <div class='row'>
                                 <div class='col-md-12'>                           
                                     <label for="content">話題內容描述：</label>
                                    <textarea required  type="text" placeholder="請填寫話題內容" name="content" rows="6" cols="53"  Wrap='Soft'></textarea>
                                    <div class="display:inline">
                                        <button class="btn btn-lg  btn-primary text-center"  type="submit" name="submit" onClick="createDiscuss()">新增話題</button>
