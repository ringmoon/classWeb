        ...
        <div class="row">
                 ...
                 <div id="divleft">
                   <div id="menu">
                    ...
                    <ul>
                        ...
                        ?> 
                        <li>
                            <p><a onclick='displayClassMembers(1)' href="classIntroduction.php">班級介紹</a></p>
                        </li>                
                        <?php
            ...
            <div class="col-md-9">    
                 <div id="divright">
                     ...
                     <div id="menu">
                     <p style="text-align:center;font-size:200%;color:black;font-weight: bold;font-family: '微軟正黑體';">我的活動行事曆</p>
                    </div>
               
                <div style="margin-left:40px;margin-right:40px">
                   <br/><br/>                 
                    <div id='futureCalendar'>   
                        
                        <script> displayFutureActivityCalendar(-1); </script>
                   </div>
                   <br/>
                    <div id='expireCalendar'>   
                        
                        <script> displayExpireActivityCalendar(-1); </script>
                   </div>
                </div>            
            </div>
