        ...
        <div class="row">
            ...
            <div class="col-md-9">    
                 <div id="divright">
                     ...
                     <div id="menu">
                     <p style="text-align:center;font-size:200%;color:black;font-weight: bold;font-family: '微軟正黑體';">新增相簿</p>
                    </div>
                ...
                <br/><br/>
                    ...
                    <form action='action.php' method='post'  enctype='multipart/form-data'>
                        <label for='imageName'>相片名稱：</lebel>
                        <input required style='width:68%'  name='imageName' type='text'/><br/><br/>
                        <input style='width:100%' name='file' type='file'/><br/>
                        <div style='text-align:right'>
                        <button onclick='createPhoto()' class='btn btn-lg btn-primary' type='submit'>確定新增</button>
                        </div>
                    </form>
                    </div></div>
                  <br/><br/>  <br/>
