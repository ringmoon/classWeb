             ...
             <div class="col-md-3">
              ...
              <div class="col-md-9">    
                 <div id="divright">
                     ...
                     <div id="menu">
                     <p style="text-align:center;font-size:200%;color:black;font-weight: bold;font-family: '微軟正黑體';">活動修改</p>
                    </div>
                    
                    <div class='row'>
                    <div class="col-md-10 col-md-offset-1">
                        <br><br>
                        <form class="form-horizontal" name="updateActivityFrom" action="action.php" method="get">
                            <? 
                                displayUpdateActionForm();
                            ?>
