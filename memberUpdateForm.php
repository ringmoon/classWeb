             ...
             <div class="col-md-3">
              ...
              <div class="col-md-9">    
                 <div id="divright">
                     ...
                     <div id="menu">
                     <p style="text-align:center;font-size:200%;color:black;font-weight: bold;font-family: '微軟正黑體';">會員修改</p>
                    </div>
                    <div class='row'>
                    <div class="col-md-10 col-md-offset-1">
                        <br><br>
                        <form class="form-horizontal" name="UpdateMemberFrom" action="action.php" method="post">
                          
                             <div class='row'>
                                 <div class='text-center'>                                                           
                                    <div>
                                        <?php displayMemberAuthorityData() ?>
                                        <button class="btn btn-lg  btn-primary text-center"  type="submit" name="submit" onClick="updateMember()">修改會員資料</button>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-lg  btn-warning text-center"  type="reset" name="reset">回復原始資料</button>
                                    </div>
                                 </div>
                            </div>
                        </form>
