             ...
             <div class="col-md-3">
              ...
              <div class="col-md-9">    
                 <div id="divright">
                     ...
                     <div id="menu">
                     <p style="text-align:center;font-size:200%;color:black;font-weight: bold;font-family: '微軟正黑體';">會員權限設定</p>
                    </div>
               
                <div style="margin-left:20px;margin-right:20px">
                  <div id="authorityDataTable">
                        <script>goAuthorityDataTable(-1)</script>
