            ...
            <div class="col-md-9">    
                ...
                <br/><br/>
                    ...
                    <form action='action.php' method='post'>
                        <label for='dirName'>相簿名稱：</lebel>
                        <input  required size=20 name='dirName' type='text'/>&nbsp;&nbsp;&nbsp;
                        <button onclick='createPhotoDir()' class='btn btn-lg btn-primary' type='submit'>確定新增</button>
                    </form>
                  <br/><br/>  <br/>
