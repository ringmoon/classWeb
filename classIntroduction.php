        ...
        <div class="row">
            ...
            <div class="col-md-9">    
                 <div id="divright">
                     ...
                     <div id="menu">
                     <p style="text-align:center;font-size:200%;color:black;font-weight: bold;font-family: '微軟正黑體';">班級介紹</p>
                    </div>
               
                <div style="margin-left:40px;margin-right:40px">
                    <div class='text-center'>
                        <img  style='width:100%' src='/img/member/group.jpg'></img>
                    </div><br/><br/>
                    <div id='classMemberTable'>   
                        <script> displayClassMembers(-1); </script>
                   </div>
                </div>            
            </div>
