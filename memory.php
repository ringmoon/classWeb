    ...
    <div id="divcontent" class="container" >      
        <div class="row">
            ...
            <div class="col-md-9">    
                ...
                <button onclick="goUrl('createPhotoDir.php')" class='btn btn-lg btn-primary' >新增相簿</button>  </div><hr/>
                ...
                <br/><br/>
                  <div id="divright">
                     ...
                     <div id="menu">
                     <p style="text-align:center;font-size:200%;color:black;font-weight: bold;font-family: '微軟正黑體';">影音</p>
                    </div>
               
                <div style="margin-left:40px;margin-right:40px">
                                      
                <div style='text-align:right;margin-top:20px;margin-bottom:-10px;'>
                <button  onclick="goUrl('createVideoDir.php')" class='btn btn-lg btn-primary' >新增影音資料夾</button>  </div><hr/>
                <div style='text-align:center'>
                <?php displayVideoDir() ?>
